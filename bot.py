...
# كلمات مرادفة/جموع بتتحول لكلمة موحدة قبل البحث
SYNONYMS = {
    # شقة
    "شقق": "شقة",
    "شقه": "شقة",
    ...
    # مزرعة (اختياري لو بتضيف نوع مزرعة لاحقًا)
    "مزارع": "مزرعة",
}

# كلمات حشو نتجاهلها من البحث (أسئلة، أفعال، أدوات)
STOPWORDS = {
...
def preprocess_query(query: str) -> str:
    ...
    query = normalize_text(preprocess_query(query.strip()))
